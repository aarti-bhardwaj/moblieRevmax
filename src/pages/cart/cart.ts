...
export class CartPage {
  ...
  constructor(public navCtrl: NavController, 
    ...
    public viewCtrl: ViewController, private appConfig: AppConfig) {
      this.getCartItems= { "02e291456ef5c7071524150a3cfec701": { "0": false, "product_id": 8490, "variation_id": 8492, "variation": { "attribute_select-vehicle": "4 Wheel Drive", "attribute_torque-converter-stall-speed": "Ultra High Stall (+800 RPM) Race Only", "attribute_valve-body-options": "Constant Pressure (Race Only)" }, "quantity": 1, "line_total": 4195, "line_subtotal": 4195, "line_tax": 0, "line_subtotal_tax": 0, "line_tax_data": { "total": [], "subtotal": [] }, "data": { "post_type": "product_variation" }, "product_data": { "ID": 8492, "post_author": "5", "post_date": "2017-02-03 23:37:31", "post_date_gmt": "2017-02-03 23:37:31", "post_content": "", "post_title": "Dodge Rebuilt 48RE Signature Series Transmission", "post_excerpt": "", "post_status": "publish", "comment_status": "closed", "ping_status": "closed", "post_password": "", "post_name": "product-8490-variation", "to_ping": "", "pinged": "", "post_modified": "2017-02-06 09:52:46", "post_modified_gmt": "2017-02-06 09:52:46", "post_content_filtered": "", "post_parent": 8490, "guid": "https:\/\/revmaxconverters.com\/product\/dodge-rebuilt-48re-signature-series-transmission\/", "menu_order": 0, "post_type": "product_variation", "post_mime_type": "", "comment_count": "0", "filter": "raw" } }, "fccd678d1a8776f97541102694953a18": { "forced_by": "02e291456ef5c7071524150a3cfec701", "product_id": 5260, "variation_id": 0, "variation": "", "quantity": 1, "line_total": 1500, "line_subtotal": 1500, "line_tax": 0, "line_subtotal_tax": 0, "line_tax_data": { "total": [], "subtotal": [] }, "data": { }, "product_data": { "ID": 5260, "post_author": "1", "post_date": "2016-08-05 04:43:06", "post_date_gmt": "2016-08-05 04:43:06", "post_content": "What is a Core Charge?\r\nA \u201cCore Charge\u201d is similar to the deposit you might pay for a can or bottle of soda. In many states, to promote recycling, you are charged a deposit when you purchase a can of soda and you receive your deposit back when you return the empty can. Many automotive parts have a Core Charge, or Core Price, that works the same way as a soda can deposit.\r\n\r\nHere\u2019s how the Core Charge works:\r\n<ul>\r\n \t<li>The part you are purchasing contains a component that is recyclable<\/li>\r\n \t<li>The Core Charge deposit is charged at the time of purchase<\/li>\r\n \t<li>When the recyclable component from your old part is returned to us, the charge is refunded to you<\/li>\r\n<\/ul>\r\nTo receive your Core Charge refund, you can do either of the following:\r\n<ul>\r\n \t<li>Bring the part to any RevMax Parts store along with your receipt or packing slip<\/li>\r\n \t<li>Mail the part back to RevMax Auto Parts following the directions on your packing slip<\/li>\r\n \t<li>Please see our Returns policy for more information on returning a core item.<\/li>\r\n<\/ul>\r\nCore Charges are often mandated by state legislature, and, as such, the actual core charge and taxes on the charge may vary depending on the state in which you buy your part.", "post_title": "Refundable Core Charge ($1,500)", "post_excerpt": "", "post_status": "publish", "comment_status": "closed", "ping_status": "closed", "post_password": "", "post_name": "refundable-core-charge-1500", "to_ping": "", "pinged": "", "post_modified": "2017-06-13 06:23:18", "post_modified_gmt": "2017-06-13 10:23:18", "post_content_filtered": "", "post_parent": 0, "guid": "https:\/\/revmaxconverters.com\/?post_type=product&#038;p=5260", "menu_order": 0, "post_type": "product", "post_mime_type": "", "comment_count": "0", "filter": "raw" } } };
  ...
  removeFromCart(item, i){ 
    ...
    this.storage.set("cart", this.cartItems).then( ()=> {
      ...
      if (item.forcell_products != "") {
        this.total = this.total - (item.forcell_products.product_price * quantity);
      }
